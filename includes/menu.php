...
var ourURL = 'https://designer.ubicall.com/?access_token='+token;
window.open(ourURL);
}
...
<li><a href="index.php?pg=agents" class="nav-top-item no-submenu <?php if($_GET['pg']=='agents') echo "current"; ?>" title="Agents">Agent</a>
