...
{    
    ...
    //add
    $last_queue_id=$queue_manager->add_queue($name,$number,$password,$wrap_up_time,$agent_announcement,$policy,$cidname,$qweight,$music_on_hold,
            $callrecording,$caller_vol_adj,$agent_vol_adj,$autopause,$maxcallers,$joinempty,$leaveempty,$s_agent,$d_agent);
    //echo $last;
    
    
    $admin_data = $queue_manager->select_admin_licence($last_queue_id);
...
//loop
    ...
    foreach($_POST['s_agent'] as $a)
    {
        ...
        $queue_manager->set_agent_queue($a,$agent_name ,$last_queue_id , $queue_name , $client_id , $client_name);
